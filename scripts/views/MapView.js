// Start the map
define(['leaflet','jquery', 'underscore', 'backbone', 'leafletDraw'], function(L,$, _, Backbone) {
	...
	var MapView = Backbone.View.extend({
		...
		initMap : function() {
			...
			$("#title").append(this.render().el);
			//Make sure our View el is attached to the document
